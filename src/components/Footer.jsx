    ...
    >
      ...
      <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div>
            ...
            <div className="mt-16 flex gap-3">
              <a
                className="rounded-full border border-red-600 p-2 hover:opacity-75"
                href=""
                target="_blank"
                rel="noreferrer"
              >
        ...
        <div className="mt-12 border-t border-gray-800 pt-12">
          <div className="text-sm text-white sm:flex sm:items-center sm:justify-between">
            <p className="mt-4 sm:mt-0">&copy; 2022 KT Builders.</p>
          </div>

          <p className="mt-8 text-xs text-white">
            Made with ❤️ and React. Designed & Developed by NEWRGM
          </p>
        </div>
      </div>
    </footer>
